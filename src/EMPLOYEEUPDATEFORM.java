...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(shiftTF, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(upBTN)
                    .addComponent(delBTN))
   ...
   String query ="UPDATE EMPLOYEE SET EMP_NAME = '"+nameTF.getText()+"' , MOBILE_NO = '"
            + mobileTF.getText()+"' , ADDRESS = '" + addressTF.getText() + 
           "' , SHIFT = '" + shiftTF.getText() +" '   WHERE EMP_ID =  '" + idTF.getText()+"' ;";
   ...
   JOptionPane.showMessageDialog(null,"Record Successfully updated" );
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost/RESTAURANT","root","password");
    Statement stmt = con.createStatement() ;
    String query ="DELETE FROM EMPLOTEE WHERE EMP_ID = '" + idTF.getText() + "' ;";
    stmt.executeUpdate(query);
